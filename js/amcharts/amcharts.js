...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function() {
        ...
        for (t = 0; t < v.length; t++) {
            var D = v[t];
            this.reversedOrder && (D = v[v.length - t - 1]);
            u = D.getBBox();
            var z;
...
AmCharts.AmSerialChart = AmCharts.Class({
    ...
    countColumns: function() {
        ...
        for (h = 0; h < b; h++) {
            e = this.valueAxes[h];
            var k = e.stackType;
            if ("100%" == k || "regular" == k) for (f = !1, g = 0; g < c; g++) d = this.graphs[g], d.hidden || (d.valueAxis != e || "column" != d.type) || (!f && d.stackable && (a++, f = !0), d.stackable || a++, d.columnIndex = a - 1);
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
                ...
                if (0 < y) {
                    ...
                    for (d = this.fillAlpha = 0; d < y; d++) {
                        var D = w[d],
                            z = NaN,
                            H = D.above;
                        isNaN(D.toValue) || (z = this.getCoordinate(D.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, D), this.pushAxisItem(t, H));
                        var E = NaN;
                        isNaN(D.value) || (E = this.getCoordinate(D.value), t = new this.axisItemRenderer(this, E, D.label, !0, NaN, (z - E) / 2, D), this.pushAxisItem(t, H));
                        isNaN(z - E) || (t = new this.guideFillRenderer(this, E, z, D), this.pushAxisItem(t, H), t = t.graphics(), D.graphics = t, D.balloonText && this.addEventListeners(t, D))
                    }
                    this.fillAlpha = x
                }
                w = !1;
                ...
                for (d = n; d < s; d += r) if (n = this.step * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n) if (isNaN(v) || Number(AmCharts.toFixed(n, v)) == n) {
                    !0 === h && (0 === n && (n = this.minReal), 2 < q && (n = Math.pow(10, d)), w = -1 != String(n).indexOf("e") ? !0 : !1);
                    this.useScientificNotation && (w = !0);
                    this.usePrefixes && (w = !1);
                    w ? (t = -1 == String(n).indexOf("e") ? n.toExponential(15) : String(n), t = t.split("e"),
                    c = Number(t[0]), t = Number(t[1]), c = AmCharts.roundTo(c, 14), 10 == c && (c = 1, t += 1), t = c + "e" + t, 0 === n && (t = "0"), 1 == n && (t = "1")) : (h && (c = String(n).split("."), u.precision = c[1] ? c[1].length : -1), t = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, u, !0) : AmCharts.formatNumber(n, u, u.precision));
                    ...
                    if (n == this.baseValue && "radar" != k) {
                        ...
                        I && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), c = AmCharts.line(a.container, I, K, this.gridColor, c, 1, this.dashLength), c.translate(n,
    ...
    stackGraphs: function(a) {
        ...
        if (n && ("regular" == b || "100%" == b)) for (p = 0; p < h.length; p++) m = h[p], m.hidden || (l = m.type, m.chart == this.chart && (m.valueAxis == this && a == l && m.stackable) && (k && (m.stackGraph = k), k = m));
    ...
    draw: function() {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                var g = Math.ceil(this.timeDifference / r) + 1,
                ...
                if (this.cellWidth = this.getStepWidth(b), b < g && (g = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < g) for (u = Math.floor(b / g), l = f, l / 2 == Math.round(l / 2) && l--, 0 > l && (l = 0), g = 0, b = l; b <= this.end + 2; b++) if (0 <= b && b < this.data.length ? (n = this.data[b], m = n.category) : m = "", b / u == Math.round(b / u) || n.forceShow) {
                ...
                if (this.data[l].time != AmCharts.resetDateToMin(new Date(this.data[l].time), e, p, v).getTime()) for (v = 0, w = m, b = l; b < s; b++) a = this.data[b].time, this.checkPeriodChange(e, p, a, w) && (v++, 2 <= v && (l = b, b = s), w = a);
                for (b = l; b < s; b++) if (a = this.data[b].time, this.checkPeriodChange(e, p, a, m)) {
                    ...
                    m = AmCharts.formatDate(new Date(a), m);
                    if (b == d && !h || b == g && !k) m = " ";
                    r ? r = !1 : (u || (t = !1), l - this.previousPos > this.safeDistance * Math.cos(this.labelRotation * Math.PI / 180) && (this.labelFunction && (m = this.labelFunction(m, new Date(a), this)), m = new this.axisItemRenderer(this, l, m, void 0, void 0, void 0, void 0, t), v = m.graphics(), this.pushAxisItem(m), this.previousPos = l + v.getBBox().width));
                    m = a
                }
            }
            for (b = 0; b < this.data.length; b++) if (h = this.data[b]) k = this.parseDates && !this.equalSpacing ? Math.round((h.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - f), h.x[this.id] = k;
            ...
            g, k.label, !1, 2 * v, NaN, k) : new this.axisItemRenderer(this, g, k.label, !1, NaN, v, k), this.pushAxisItem(m, d)), u = new this.guideFillRenderer(this, g, u, k), g = u.graphics(), this.pushAxisItem(u, d), k.graphics = g, g.index = b, k.balloonText && this.addEventListeners(g, k)
        }
        this.axisCreated = !0;
        c = this.x;
        f = this.y;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k) {
        ...
        if ("H" == Fa) {
            if (0 <= b && b <= R + 1 && (0 < u && (0 < v && b + k <= R + 1) && (ma = AmCharts.line(r, [b + k, b + k], [0, u], q, v, w), n.push(ma)), 0 < t && (X = AmCharts.line(r, [b, b + S, b + S], [T, T + Q, Q], y, t, w, x), n.push(X))), A = 0, G = b, g && 90 == E && (G -= m), !1 === d ? (X = "start", A = "bottom" == da ? K ? A + u : A - u : K ? A - u : A + u, G += 3, e && (G += e / 2, X = "middle"), 0 < E && (X = "middle")) : X = "middle", 1 == I && (0 < z && !g && ha < R) && (d = AmCharts.fitToBounds(b, 0, R), ha = AmCharts.fitToBounds(ha,
            0, R), ja = d - ha, 0 < ja && (fill = AmCharts.rect(r, ja, a.height, D, z), fill.translate(d - ja + S, Q), n.push(fill))), "bottom" == da ? (A += T + m / 2 + W, K ? 0 < E ? (A = T - ga / 2 * Math.sin(Y) - u - 3, G += ga / 2 * Math.cos(Y)) : A -= u + m + 3 + 3 : 0 < E ? (A = T + ga / 2 * Math.sin(Y) + u + 3, G -= ga / 2 * Math.cos(Y)) : A += u + s + 3 + 3) : (A += Q + m / 2 - W, G += S, K ? 0 < E ? (A = ga / 2 * Math.sin(Y) + u + 3, G -= ga / 2 * Math.cos(Y)) : A += u + 3 : 0 < E ? (A = -(ga / 2) * Math.sin(Y) - u - 6, G += ga / 2 * Math.cos(Y)) : A -= u + m + 3 + s + 3), "bottom" == da ? ja = (K ? T - u - 1 : T + s - 1) + W : ($ = S, ja = (K ? Q : Q - u - s + 1) - W), f && (G += f), Q = G, 0 < E && (Q += ga / 2 * Math.cos(Y)), U && (da = 0, K && (da = ga / 2 * Math.cos(Y)), Q + da > R + 2 || 0 > Q)) U.remove(), U = null
        } else {
            ...
            A = b - m / 2;
            1 == I && (0 < z && !g) && (d = AmCharts.fitToBounds(b, 0, T), ha = AmCharts.fitToBounds(ha, 0, T), Y = d - ha, fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, Y, Y], D, z), fill.translate(S, d - Y + Q), n.push(fill));
            A += m / 2;
            "right" == da ? (G += S + R + W, A += Q, K ? (G -= u + 4, f || (A -= m / 2 + 3)) : (G += u + 4 + s, A -= 2)) : K ? (G += u + 4 - W, f || (A -= m / 2 + 3), g && (G += S, A += Q)) : (G += -u - s - 4 - 2 - W, A -= 2);
            ma && ("right" == da ? ($ += S + W + R, ja += Q, $ = K ? $ - s : $ + s) : ($ -= W, K || ($ -= u + s)));
            f && (A += f);
            K = -3;
            "right" == da && (K += Q);
            U && (A > T + 1 || A < K) && (U.remove(), U = null)
        }
        ma && ma.translate($, ja);
        !1 === a.visible && (ma && ma.remove(), U && (U.remove(), U = null));
        U && (U.attr({
            "text-anchor": X
        }), U.translate(G, A), 0 !== E && U.rotate(-E), a.allLabels.push(U), " " != c && (this.label = U));
        a.counter = 0 === I ? 1 : 0;
        a.previousCoord = b;
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        var A = this.chart.columnSpacing,
            $ = Fa.cellWidth,
            ga = ($ * h - r) / r;
        A > ga && (A = ga);
        var U, F, Qa, Ya = l + 1,
        ...
        if (!Q && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Ga || void 0 != ya)) {
            ...
            p ? (Ya = l, Za = Math.abs(qb - ua), ab = l, bb = Math.abs(Ua - ua), Ta = $a = 0, f.reversed ? (Ra = 0, Sa = ua) : (Ra = ua, Sa = 0)) : (Za = k, Ya = Math.abs(qb - ua), bb = k, ab = Math.abs(Ua - ua), Sa = Ra = 0, f.reversed ? (Ta = m, $a = ua) : Ta = ua + 1)
        }
        var va = Math.round;
        this.pmx = va(Ra);
        this.pmy = va($a);
        ...
        h = "column" == g ? ($ * h - A * (r - 1)) / r : $ * h;
        1 > h && (h = 1);
        var O;
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < K) for (O = K - 1; - 1 < O; O--) if (U = d[O], F = U.axes[f.id].graphs[b], Qa = F.values.value, !isNaN(Qa)) {
                K = O;
                break
            }
            if (S < d.length - 1) for (O = S + 1; O < d.length; O++) if (U = d[O], F = U.axes[f.id].graphs[b], Qa = F.values.value, !isNaN(Qa)) {
                S = O;
                break
            }
        }
        ...
        var ea = [],
            fa = [],
            Ja = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == E || "100%" == E || this.fillToGraph) Ja = !0;
        for (O = K; O <= S; O++) {
            U = d[O];
            ...
            if (sa) {
                ...
                var oa = U.x[Fa.id],
                    ta = Math.floor($ / 2),
                    Na = ta;
                "start" == this.pointPosition && (oa -= $ / 2, ta = 0, Na = $);
                Q || (F.x = oa); - 1E5 > oa && (oa = -1E5);
                oa > k + 1E5 && (oa = k + 1E5);
                p ? (C = B, P = N, N = B = oa, isNaN(ia) && !this.fillToGraph && (P = da), Ka = za, La = Aa) : (P = C = oa, isNaN(ia) && !this.fillToGraph && (N = da));
                V < ia && (F.isNegative = !0, Ga && (wa = Ga), Ia && (Ma = Ia), void 0 != ya && (na = ya));
                switch (g) {
                    case "line":
                        isNaN(V) ? s || (this.drawLineGraph(q, v, ea, fa), q = [], v = [], ea = [], fa = []) : (F.isNegative = V < ha ? !0 : !1, q.push(C), v.push(B), Z = C, ca = B, pa = C, qa = B, !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P),
                        fa.push(N)));
                        break;
                    case "smoothedLine":
                        isNaN(V) ? s || (this.drawSmoothedGraph(q, v, ea, fa), q = [], v = [], ea = [], fa = []) : (F.isNegative = V < ha ? !0 : !1, q.push(C), v.push(B), Z = C, ca = B, pa = C, qa = B, !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P), fa.push(N)));
                        break;
                    case "step":
                        isNaN(V) ? s || (t = NaN, this.drawLineGraph(q, v, ea, fa), q = [], v = [], ea = [], fa = []) : (F.isNegative = V < ha ? !0 : !1, p ? (isNaN(u) || (q.push(u), v.push(B - ta)), v.push(B - ta), q.push(C), v.push(B + Na), q.push(C), !Ja || (isNaN(N) || isNaN(P)) || (ea.push(w), fa.push(N - ta), ea.push(P), fa.push(N - ta),
                        ea.push(P), fa.push(N + Na))) : (isNaN(t) || (v.push(t), q.push(C - ta)), q.push(C - ta), v.push(B), q.push(C + Na), v.push(B), !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P - ta), fa.push(y), ea.push(P - ta), fa.push(N), ea.push(P + Na), fa.push(N))), u = C, t = B, w = P, y = N, Z = C, ca = B, pa = C, qa = B);
                        break;
                    case "column":
                        la = na;
                        void 0 != F.lineColor && (la = F.lineColor);
                        if (!isNaN(V)) {
                            V < ha ? (F.isNegative = !0, Ga && (wa = Ga), void 0 != ya && (na = ya)) : F.isNegative = !1;
                            var rb = f.min,
                                sb = f.max;
                            if (!(V < rb && ia < rb || V > sb && ia > sb)) if (p) {
                                "3d" == E ? (M = B - 0.5 * (h + A) + A / 2 + H * T, L = P + z * T) : (M = B - (r / 2 - T) * (h + A) + A / 2, L = P);
                                J = h;
                                Z = C;
                                ca = M + h / 2;
                                pa = C;
                                ...
                                if (M < l && 0 < J && (ka = new AmCharts.Cuboid(e, aa, J, z - a.d3x, H - a.d3y, wa, Ma, R, la, W, G, n, p), "bottom" != I)) if (I = f.reversed ? "left" : "right", 0 > V) I = f.reversed ? "right" : "left";
                                else if ("regular" == E || "100%" == E) Z += this.dx
                            } else {
                                "3d" == E ? (L = C - 0.5 * (h + A) + A / 2 + z * T, M = N + H * T) : (L = C - (r / 2 - T) * (h + A) + A / 2, M = N);
                                J = h;
                                Z = L + h / 2;
                                ca = B;
                                pa = L + h / 2;
                                ...
                                if (L < k + T * z && 0 < J) if (ka = new AmCharts.Cuboid(e, J, aa, z - a.d3x, H - a.d3y, wa, Ma, R, la, this.lineAlpha, G, n, p), 0 > V && "middle" != I) I = "bottom";
                                else if (I = ja, "regular" == E || "100%" == E) ca += this.dy
                            }
                            if (ka && (ra = ka.set, ra.translate(L, M), this.columnsSet.push(ra), (F.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), !Q)) {
                                "none" == E && (D = p ? (this.end + 1 - O) * x - c : x * O + c);
                                "3d" == E && (p ? (D = (x - c) * (this.end + 1 - O),
                                Z += z * this.columnIndex, pa += z * this.columnIndex, F.y += z * this.columnIndex) : (D = (x - c) * (O + 1), Z += 3, ca += H * this.columnIndex + 7, qa += H * this.columnIndex, F.y += H * this.columnIndex));
                                if ("regular" == E || "100%" == E) I = "middle", D = p ? 0 < sa.value ? (this.end + 1 - O) * x + c : (this.end + 1 - O) * x - c : 0 < sa.value ? x * O + c : x * O - c;
                                ...
                                this.animateColumns(ka, O, C, P, B, N);
                    ...
                    case "candlestick":
                        if (!isNaN(ia) && !isNaN(V)) {
                            ...
                            void 0 != F.lineColor && (la = F.lineColor);
                            if (p) {
                                if (M = B - h / 2, L = P, J = h, M + J > l && (J = l - M), 0 > M && (J += M, M = 0), M < l && 0 < J) {
                                    var fb, gb;
                                    V > ia ? (fb = [C, La], gb = [P, Ka]) : (fb = [P, La], gb = [C, Ka]);
                                    !isNaN(La) && !isNaN(Ka) && (B < l && 0 < B) && (Va = AmCharts.line(e, fb, [B, B], la, W, R), eb = AmCharts.line(e, gb, [B, B], la, W, R));
                                    aa = C - P;
                                    ka = new AmCharts.Cuboid(e, aa, J, z, H, wa, Ha, R, la, W, G, n, p)
                                }
                            } else if (L = C - h / 2, M = N + R / 2, J = h, L + J > k && (J = k - L), 0 > L && (J += L, L = 0), aa = B - N, L < k && 0 < J) {
                                var ka = new AmCharts.Cuboid(e, J, aa, z, H, wa, Ma, R, la, W, G, n, p),
                                    hb, ib;
                                V > ia ? (hb = [B, Aa], ib = [N, za]) : (hb = [N, Aa], ib = [B, za]);
                                !isNaN(Aa) && !isNaN(za) && (C < k && 0 < C) && (Va = AmCharts.line(e, [C, C], hb, la, W, R), eb = AmCharts.line(e, [C, C], ib, la, W, R))
                            }
                            ka && (ra = ka.set, Y.push(ra), ra.translate(L, M - R / 2), (F.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), Va && (Y.push(Va), Y.push(eb)), Z = C, ca = B, pa = C, qa = B, Q || (F.x = p ? M + J / 2 : L + J / 2, this.animateColumns(ka, O, C, P, B, N), this.addListeners(ra, F)))
                        }
                        break;
                    case "ohlc":
                        if (!(isNaN(ia) || isNaN(cb) || isNaN(db) || isNaN(V))) {
                            V < ia && (F.isNegative = !0, void 0 != ya && (na = ya));
                            var jb, kb, lb;
                            if (p) {
                                var mb = B - h / 2,
                                    mb = AmCharts.fitToBounds(mb,
                                    0, l),
                                    tb = AmCharts.fitToBounds(B, 0, l),
                                    nb = B + h / 2,
                                    nb = AmCharts.fitToBounds(nb, 0, l);
                                kb = AmCharts.line(e, [P, P], [mb, tb], na, W, R, X);
                                0 < B && B < l && (jb = AmCharts.line(e, [Ka, La], [B, B], na, W, R, X));
                                lb = AmCharts.line(e, [C, C], [tb, nb], na, W, R, X)
                            } else {
                                var ob = C - h / 2,
                                    ob = AmCharts.fitToBounds(ob, 0, k),
                                    ub = AmCharts.fitToBounds(C, 0, k),
                                    pb = C + h / 2,
                                    pb = AmCharts.fitToBounds(pb, 0, k);
                                kb = AmCharts.line(e, [ob, ub], [N, N], na, W, R, X);
                                0 < C && C < k && (jb = AmCharts.line(e, [C, C], [za, Aa], na, W, R, X));
                                lb = AmCharts.line(e, [ub, pb], [B, B], na, W, R, X)
                            }
                            Y.push(kb);
                            Y.push(jb);
                            Y.push(lb);
                ...
                if (!Q && !isNaN(V)) {
                    ...
                    if (this.end - this.start <= vb || 0 === vb) {
                        var Da = this.createBullet(F, pa, qa, O);
                        Da || (Da = 0);
                        ...
                        if (wb) {
                            ...
                            switch (I) {
                                ...
                                case "bottom":
                                    ...
                                    break;
                                case "middle":
                                    "column" == g && (p ? (Ba = -(Xa / 2) + this.fontSize / 2, xa = -(C - P) / 2 - z, 0 > aa && (xa += z), Math.abs(C - P) < Wa && !this.showAllValueLabels && (ba.remove(), ba = null)) : (Ba = -(B - N) / 2, 0 > aa && (Ba -= H), Math.abs(B - N) < Xa && !this.showAllValueLabels && (ba.remove(), ba = null)))
                            }
                            if (ba) {
                        ...
                        if ("column" == g && "regular" == E || "100%" == E) {
                            ...
                            if (zb) {
                                ...
                                var Ab = Ea.getBBox(),
                                    ...
                                    Oa, Pa, Db = f.totals[O];
                                Db && Db.remove();
                                p ? (Pa = B, Oa = 0 > V ? C - Bb / 2 - 2 : C + Bb / 2 + 3) : (Oa = C, Pa = 0 > V ? B + Cb / 2 : B - Cb / 2 - 3);
                                Ea.translate(Oa, Pa);
                                f.totals[O] = Ea;
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < v) if (l = a.join(";").split(";"), m = b.join(";").split(";"), "serial" == e.chartType && (0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), m = b.concat(d)) : e.rotate ? (m.push(m[m.length - 1]), l.push(u), m.push(m[0]),
            l.push(u), m.push(m[0]), l.push(l[0])) : (l.push(l[l.length - 1]), m.push(u), l.push(l[0]), m.push(u), l.push(a[0]), m.push(m[0]))), 0 < f && (a = AmCharts.polygon(g, l, m, n, f, 0, 0, 0, this.gradientRotation), h.push(a)), q || void 0 !== s) isNaN(v) && (v = f), q || (q = s), g = AmCharts.polygon(g, l, m, q, v, 0, 0, 0, this.gradientRotation), k.push(g), k.click(function() {
                e.handleGraphClick()
            });
            e.applyMask(k, h)
        }
    ...
    b, c, d) {
        if (1 < a.length) {
            ...
            0 < m && (l = a.join(";").split(";"), v = b.join(";").split(";"), k = "", 0 < c.length ? (c.reverse(),
            d.reverse(), l = a.concat(c), v = b.concat(d)) : (this.rotate ? (k += " L" + q + "," + b[b.length - 1], k += " L" + q + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + q, k += " L" + a[0] + "," + q), k += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, l, v, NaN, 0, 0, p, m, e, k), g.push(c.path), n || void 0 !== r) && (s || (s = m), n || (n = r), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, n, s, e, k), h.push(a.path));
            this.applyMask(h, g)
        }
    },
    ...
    createBullet: function(a, b, c, d) {
        ...
        if ("none" != this.bullet || a.bullet) {
            ...
            switch (e) {
                case "round":
                    ...
                    break;
                case "square":
                    h = AmCharts.polygon(d, [0, f, f, 0], [0, 0, f, f], p, r, g, l, m);
                    b -= f / 2;
                    c -= f / 2;
                    k = -f / 2;
                    break;
        ...
        f, f), this.centerCustomBullets && (b -= f / 2, c -= f / 2, e -= f / 2, g -= f / 2)));
        ...
        if (this.enabled) {
            ...
            if (r) {
                var n = r.x[f.id],
                    ...
                    H = c.graphs,
                    E = f.axisThickness;
                if (c.mouseIsOver || D || z || this.forceShow) if (this.forceShow = !1, z) {
                    var g = this.panClickPos,
                        c = this.panClickEndTime,
                        D = this.panClickStartTime,
                        I = this.panClickEnd,
                    ...
                    0 !== d && (g = {
                        type: "zoomed",
                        target: this
                    }, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > w && (d = w - c), D + d < t && (d = t - D), g.start = D + d, g.end = c + d, this.fire(g.type, g)) : I + d >= this.data.length || 0 > k + d || (g.start = k + d, g.end = I + d, this.fire(g.type, g)))
                } else {
                    ...
                    D && (s ? this.updateSelectionSize(NaN, n) : this.updateSelectionSize(n, NaN));
                    t = !0;
                    D && (t = !1);
                    ...
                    if (H && this.valueBalloonsEnabled && t && c.balloon.enabled) {
                        ...
                        for (f = 0; f < H.length; f++) if (w = H[f], (!this.oneBalloonOnly || w == I) && (w.showBalloon && !w.hidden && w.balloonText) && (v = r.axes[w.valueAxis.id].graphs[w.id], u = v.y, !isNaN(u))) {
                            q = v.x;
                            n = !0;
                            if (s) {
                                if (h = u, 0 > q || q > p) n = !1
                    ...
                    b ? (g = {
                        type: "changed"
                    }, g.index = a, g.target = this, g.chart = this.chart, g.zooming = D, g.mostCloseGraph = I, g.position = s ? e : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    handleMouseDown: function(a) {
        if (this.zoomable || this.pan || this.drawing) {
            var b = this.rotate,
                ...
                d = c.mouseX - this.x,
                e = c.mouseY - this.y;
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a) this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? e : d, this.panClickStart = this.start,
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    e = "";
    if (0 < k) {
        n ? (path = " M" + s + "," + (v + k) + " L" + u + "," + (t + k), H || (path += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + u + "," + (t + k) + "," + w + "," + (y + k)), path += " L" + x + "," + (q + k), 0 < h && (H || (path += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + x + "," + (k + q) + "," + s + "," + (k + v)))) : (path = " M" + s + "," + (v + k) + " L" + u + "," + (t + k), path += " A" + f + "," + g + ",0," + z + ",1," + w + "," + (y + k) + " L" + x + "," + (q + k), 0 < h && (path += " A" + h + "," + r + ",0," + z + ",0," + s + "," + (v + k)));
        path += " Z";
        var E = a.path(path, void 0, void 0, "1000,1000").attr(D);
        d.push(E);
        E = a.path(" M" + s + "," + v + " L" + s + "," + (v + k) + " L" + u + "," + (t + k) + " L" + u + "," + t + " L" + s + "," + v + " Z", void 0, void 0, "1000,1000").attr(D);
        k = a.path(" M" + w + "," + y + " L" + w + "," + (y + k) + " L" + x + "," + (q + k) + " L" + x + "," + q + " L" + w + "," + y + " Z", void 0, void 0, "1000,1000").attr(D);
        d.push(E);
        d.push(k)
    }
...
AmCharts.AmPieChart = AmCharts.Class({
    ...
    checkOverlapping: function(a, b, c, d, e) {
        var f, g, h = this.chartData,
            ...
            l = b.label;
        if (l) {
            if (!0 === d) for (g = a + 1; g < k; g++)(f = this.checkOverlappingReal(b,
            h[g], c)) && (g = k);
            else for (g = a - 1; 0 <= g; g--)(f = this.checkOverlappingReal(b, h[g], c)) && (g = 0);
    ...
    parseData: function() {
        ...
        if (void 0 !== b) {
            ...
            for (e = 0; e < a.length; e++) this.pieBaseColor ? g = AmCharts.adjustLuminosity(this.pieBaseColor, e * this.pieBrightnessStep / 100) : (g = this.colors[e],
    ...
    dispatchAxisZoom: function() {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if (!isNaN(c.min) && !isNaN(c.max)) {
                var d, e;
                "V" == c.orientation ? (d = c.coordinateToValue(-this.verticalPosition), e = c.coordinateToValue(-this.verticalPosition + this.plotAreaHeight)) : (d = c.coordinateToValue(-this.horizontalPosition), e = c.coordinateToValue(-this.horizontalPosition + this.plotAreaWidth));
                if (!isNaN(d) && !isNaN(e)) {
                    if (d > e) {
                        var f = e;
                        e = d;
